...
class RedisService {
    ...
    interface Service {
        ...
        @GET("GET/{key}")
        Call<GetResponse> getScore(@Path("key") String key);
        ...
        @PUT("SET/{key}")
        Call<SetResponse> setScore(@Path("key") String key, @Body SetScoreRequest body);
    ...
    class DelResponse {
        @SerializedName("GET")
        SetScoreRequest delete;
    }

    static class SetScoreRequest {
        int score;

        public SetScoreRequest(int score) {
            this.score = score;
        }
    }
    ...
    static Service getService() {
        if (service == null) {
            ...
            Retrofit retrofit = new Retrofit.Builder()
                    .baseUrl("http://ec2-34-197-228-35.compute-1.amazonaws.com/b2b56a4c6c620b97ffe540c1e660949f/")
